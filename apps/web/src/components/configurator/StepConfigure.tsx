...
export function StepConfigure({ modelId, model, lookups, lk, prop, lookupError, onRetryLookups, entries, onChange, onQueryPick, onNext, saving, conflicted, tables, onTablesChange }: {
  modelId: string;
  model: ModelDef;
